...
public class AsymmetricCryptography {
    ...
    public static String getEncryptedPassword(String password,String keyPath) throws Exception {
        AsymmetricCryptography ac = new AsymmetricCryptography();
        PrivateKey privateKey = ac.getPrivate(keyPath);
        String encryptedKey=ac.encryptText(password, privateKey);
        System.out.println(encryptedKey);
        return encryptedKey;
    }
    public static void main(String[] args) throws Exception {
        String password=getEncryptedPassword("cielurhdqjtveqig","TestData/KeyPair/privateKey_stage");
    }
}
